...
import { Percent, ArrowRight, ChevronDown, Loader2 } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-[140px] sm:pt-[148px] lg:pt-[152px]">
        <section className="bg-gradient-to-r from-danger via-red-600 to-rose-700 py-16 sm:py-20 mb-12">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white mb-4 font-display">Hot Deals</h1>
            <p className="text-white/90 text-lg sm:text-xl max-w-2xl mx-auto">
              Save big on top brands with discounts of 20% or more. These deals won&apos;t last long!
            </p>
          </div>
        </section>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 sm:mb-20">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
            <div>
              <p className="text-slate-500 text-sm sm:text-base">
                {sortedProducts.length} deal{sortedProducts.length !== 1 ? "s" : ""} found
              </p>
            </div>
          ...
          {isLoading && products.length === 0 && (
            <div className="flex flex-col items-center justify-center py-32 gap-4">
              ...
              <p className="text-slate-500 font-medium text-sm">Loading deals...</p>
            </div>
          )}
          ...
          {!isLoading && products.length === 0 && (
            <div className="text-center py-32">
              ...
              <p className="text-slate-500 text-sm">Check back soon for new offers</p>
            </div>
          )}
